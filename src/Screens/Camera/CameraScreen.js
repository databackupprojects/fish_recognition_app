...
const Camera = ({ navigation }) => {
  ...
  // Function to close the fish modal
  ...
  // Function to open the image gallery and select an image
  ...
  const uploadImage = async uri => {
    setSpinner(true); // Show spinner while uploading
      ...
      <View style={styles.modalContainer}>
        <RNCamera
          ...
          androidCameraPermissionOptions={{
            ...
            message: 'Need camera access for quick barcode scanning and online product search.',
            buttonPositive: 'Ok',
